using Application.Responsable.Commands.Crear;
using Application.Responsable.Commands.Update;
using Application.Responsable.Queries.Listar;
using Application.Responsable.Queries.Obtener;
...
namespace SistemaInformatico.API.Controllers
{
    ...
    public class ResponsableController : AbstractController
    {
        ...
        public async Task<IActionResult> ObtenerSegmentacion([FromRoute] int Id)
        {
            ...
            try
            {
                var response = await Mediator.Send(new ObtenerResponsableQuery { Id = Id });
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        [Route("agregar")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<IActionResult> CrearResponsable([FromBody] CreateResponsableCommand command)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<IActionResult> UpdateVariablePaft([FromRoute] int datoID, [FromBody] UpdateResponsableCommand command)
        {
